...
Stundenplan schon im Anfi-Brief, in den zwei Wochen vor offiziellem Semesterstart findet der Mathe-Vorkurs statt.
Mit dem Vorkurs gehen auch die Erstsemesterveranstaltungen los (kennenlernen der Uni, Stadt und natürlich Kommilitonen), die finden meist abends oder am Wochenende statt.

\coronabox{Anfi-Veranstaltungen finden in diesem Semester sowohl online als auch in präsenz statt. Eine Einladung mit ausführlichen Beschreibungen der Erstsemesterveranstaltungen solltet ihr schon mit eurem Erstibrief\footnote{\url{http://www.fsi.uni-tuebingen.de/erstsemester/material/start}} bekommen haben.\\ Aufgrund der sich schnell ändernden Lage sind kurzfristige Änderungen möglich, Termin-Infos daher nur auf der Website der Fachschaft\footnote{\url{text}}.\\ TeilnehmerInnenzahl leider begrenzt. Um im Vorfeld einen Überblick zu bekommen, und bei einer evtl. Infektion eine Kontaktliste zu haben, ist in diesem Semester eine Anmeldung verpflichtend\footnote{\url{text}}.}

% TODO: remove Corona-Events, add events not described here
\textbf{Mathe-Vorkurs}\\
...

\textbf{Stadtrallye (analog)}\\
...

\textbf{Stadtrallye (digital)}\\
...

\textbf{Kneipentour}\\
...

\textbf{Spieleabend (analog)}\\
...

\textbf{Spieleabend (digital)}\\
...
